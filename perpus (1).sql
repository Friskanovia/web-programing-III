...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 10, 2022 at 10:48 AM
...
INSERT INTO `buku` (`id`, `judul_buku`, `id_kategori`, `pengarang`, `penerbit`, `tahun_terbit`, `isbn`, `stok`, `dipinjam`, `idbooking`, `image`) VALUES
(1, 'belajar komputer itu mudah', 1, 'salahudin', 'elex media komputindo', 2019, '799-878-9000-54-02-2005', 3, 2524, 2579, '');
...
(1, 'friska', '', 'friskanovia123@gmail.com', 'default.jpg', '$2y$10$PFQjnT8f18nO3B8p0Zea2OVWaCLO0vXUHUkWZZ38bxJG1LRmXfrkC', 2, 1, 1636969461);
